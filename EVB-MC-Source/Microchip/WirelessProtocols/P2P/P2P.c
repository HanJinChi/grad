...
void MiApp_ConnectionMode(INPUT BYTE Mode)
{
    ...
    void Simon6496Decrypt(IOPUT DWORD text[],INPUT DWORD rk[]){
        ...
        /*********************************************************************
     * void Simon6496EncryptCTR( INPUT BYTE bytes[], 
     *                  OUTPUT BYTE ctbytes[],        
     *                  INPUT BYTE K[], 
     *                  int numbytes,
     *                  )
     *
     * Overview:     This function implements the process of SIMON 64/96 Encrypy CTR MODE
     *
     *
     * PreCondition:    None
     *
     ...
     *       
     *          BYTE  []     ctbytes    CipherText 
     *         
     *          INPUT []     K          The keys words which can generate round keys
     * 
     *          int          numbytes   the number of bytes
     * Output:          
     *          None
     *
     * Side Effects:    None
     ...
     * 
     ********************************************************************/    
    inline void Simon6496CbcMac(   INPUT BYTE *text, 
                    INPUT BYTE len, 
                    INPUT BYTE *key, 
                    OUTPUT BYTE *MIC){
        BYTE block = len / BLOCK_SIZE + 1;
         ...
         * 
         ********************************************************************/
        inline void Simon6496CcmEnc(BYTE *text, 
                        BYTE payloadLen, 
                        BYTE *key){
            BYTE i;
